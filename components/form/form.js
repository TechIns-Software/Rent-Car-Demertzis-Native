...
export  default function ExpenseForm({navigation,idForm}) {
    ...
    const [synergates, setSynergates] = useState([
        ...
        { title: 'KALESMA' },
        { title: 'KATIKIES' },
        { title: 'KATIKIES VILLAS' },
        { title: 'KEVIN ROCKS' },
        { title: 'KINGLIKE' },
        { title: 'KORALI' },
        { title: 'KOUROS' },
        { title: 'KOURREN MURRAY' },
        { title: 'KOVE' },
        { title: 'KYMA' },
        { title: 'LEGENDARY SUITES' },
        { title: 'LITHOS CAVE' },
        { title: 'LUXURY KEY' },
        { title: 'MAERA VILLAS' },
        { title: 'MAGNUS' },
